...
import com.mpm.dartsclient.adapters.PlayerScoreRecyclerViewAdapter
...
class PlayerScoreDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        var playerScoreRecyclerViewAdapter = PlayerScoreRecyclerViewAdapter(activity as Activity)
