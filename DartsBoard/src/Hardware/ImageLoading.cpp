...
void initializeImageLoading() {
    ...
    DisplayContainer::displayContainer.getTFT()->begin(ID);
    DisplayContainer::displayContainer.getTFT()->fillScreen(0x07FF);
    DisplayContainer::displayContainer.getTFT()->setTextColor(0xFFFF, 0x0000);
